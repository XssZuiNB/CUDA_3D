/* FOR NEW VERSION OF EIGEN, THIS FILE IS NOT REQUIRED */
/* See:
 * https://gitlab.com/libeigen/eigen/-/blob/master/Eigen/src/Core/util/DisableStupidWarnings.h#L76-96
 */
...
// 2259 - non-pointer conversion from "Eigen::Index={ptrdiff_t={long}}" to "int" may lose
// significant bits
#ifndef EIGEN_PERMANENTLY_DISABLE_STUPID_WARNINGS
#pragma warning push
#endif
...
// Disable the "calling a __host__ function from a __host__ __device__ function is not allowed"
// messages (yes, there are many of them and they seem to change with every version of the compiler)
